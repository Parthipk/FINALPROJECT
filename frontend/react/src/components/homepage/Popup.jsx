...
import image from '../../assets/home/loginpage.jpg'
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-xl w-[80%] md:w-[50%] relative flex">
        ...
        <div className="flex-1 p-8">
          ...
          <h2 className="text-2xl font-semibold  text-center mb-4">Applicant Login</h2>
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            ...
            <Link to="/candidateLogin" className="font-medium text-[#309689] cursor-pointer">
              sign in
            </Link>.
          </p>
        </div>
